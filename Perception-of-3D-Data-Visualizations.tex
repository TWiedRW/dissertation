...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, breakable, coltitle=black, opacitybacktitle=0.6, toprule=.15mm, left=2mm, rightrule=.15mm, toptitle=1mm, bottomtitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm]
